...
app.initializers.add('kyrne-everygreen', () => {
  ...
  extend(NotificationGrid.prototype, 'notificationTypes', function (items) {
    items.add('postMentioned', {
      name: 'postMentioned',
      icon: 'fas fa-reply',
      label: app.translator.trans('starinc-nex_comment-tree.forum.settings.notify_post_mentioned_label')
    });

    items.add('userMentioned', {
      name: 'userMentioned',
      icon: 'fas fa-at',
      label: app.translator.trans('starinc-nex_comment-tree.forum.settings.notify_user_mentioned_label')
    });
  });
