...
class ConfigureMentions
{
    ...
    private function configureUserMentions(Configurator $config)
    {
        ...
        $tag->filterChain->prepend([static::class, 'addUserId'])
            ->setJS('function(tag) { return flarum.extensions["starinc-nex_comment-tree"].filterUserMentions(tag); }');
    ...
    private function configurePostMentions(Configurator $config)
    {
        ...
        $tag->filterChain
            ...
            ->setJS('function(tag) { return flarum.extensions["starinc-nex_comment-tree"].filterPostMentions(tag); }');
